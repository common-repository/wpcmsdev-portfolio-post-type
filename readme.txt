...
This plugin will enable a "Portfolio" custom post type. The reason this is implemented as a separate plugin is so that your portfolio items are not tied to the theme. If you switch themes, your portfolio items will still be available. This plugin had been designed specificially for use in our own line of [business WordPress themes](http://wpcmsdev.com/themes/), but should still function with any theme. If you're not using the plugin in a wpCMSdev theme, you may need to [modify your theme's template files](http://codex.wordpress.org/Post_Type_Templates) for best results.
